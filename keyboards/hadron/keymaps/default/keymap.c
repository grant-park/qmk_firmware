...
[_QWERTY] = KEYMAP( 
<<<<<<< HEAD
  _______,    LGUI(KC_1), LGUI(KC_2),   LGUI(KC_3),   LGUI(KC_4),     LGUI(KC_5),           LGUI(KC_6), LGUI(KC_7), LGUI(KC_8),          LGUI(KC_9),    LGUI(KC_0),  RGB_TOG,\
...
=======
  ...
  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_LPRN, KC_RPRN, KC_DEL,  KC_AMPR, KC_ASTR, KC_LPRN,    KC_RPRN, KC_UNDS, KC_PLUS,\
  KC_TILD, CLEAN,SYNC,SEARCH_PROJ,SEARCH_CLASS,REFORMAT,OPTIMPORTS, KC_RBRC, KC_PIPE, KC_F10,  _______, _______,    KC_LCBR, KC_RCBR, KC_PIPE, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______,_______, _______,  _______, _______, _______,    KC_F12, S(KC_NUHS), S(KC_NUBS),\
  _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______,    _______, _______, KC_MNXT\
>>>>>>> ff58bedf1d4b580447a0cb24e4336a267c4cdf3c
),
[_RAISE] = KEYMAP( 
<<<<<<< HEAD
...
=======
  ...
  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_9,    KC_0,    KC_DEL,  KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL, \
  KC_GRV,  _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, _______, _______, _______, _______, KC_F12,  KC_NUHS, KC_NUBS, \
  _______, _______, _______, _______,  _______, KC_SPC, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______, _______, _______, KC_MNXT  \
>>>>>>> ff58bedf1d4b580447a0cb24e4336a267c4cdf3c
),
[_MOUSECURSOR] = KEYMAP( 
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
...
=======
  KC_F1,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, KC_MS_U, KC_F10,  KC_F11,  KC_F12, \
  RESET,   _______, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, _______, _______, KC_DEL,   RGB_SAD, KC_MS_L, KC_MS_U,  KC_MS_R, _______, _______,    \
  _______, KC_ACL0, KC_ACL1, KC_BTN1, KC_BTN2, KC_BTN3, _______,  _______,  _______, _______, KC_MS_L, KC_MS_D,  KC_MS_R, _______,  _______,  \
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   BL_INC,  BL_STEP, BL_TOGG,  MI_OFF, _______, _______,  _______,  _______, BL_DEC,     \
  _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,  _______, _______, _______    \
),
...
[_ARROWS] = KEYMAP( 
  _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,    _______, _______, KC_UP,   _______, _______, _______,\
