...
[_QWERTY] = KEYMAP( 
  ...
  KC_TAB,   KC_A,     KC_S,    KC_D,    KC_F,    KC_G,    KC_P4,   KC_P5,   KC_P6,    KC_H,    KC_J,    KC_K,     KC_L,       LT_MC(KC_SCLN),  KC_QUOT, \
...
[_LOWER] = KEYMAP( 
  ...
  KC_TILD, CLEAN,SYNC,SEARCH_PROJ,SEARCH_CLASS,REFORMAT,KC_LBRC, KC_RBRC, KC_PIPE, KC_F10,  _______, _______,    KC_LCBR, KC_RCBR, KC_PIPE, \
