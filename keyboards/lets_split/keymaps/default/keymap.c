...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [PRIMARY] = LAYOUT_ortho_4x4(
        KC_Q,      KC_W,          KC_E,           KC_R,            KC_T,                                        KC_Y,      KC_U,            KC_I,           KC_O,    KC_P, \
        KC_A,      L(MOUSE,KC_S), L(MIDDLE,KC_D), GUI(KC_F),       CTL(KC_G),                                   CTL(KC_H), GUI(KC_J),       L(MIDDLE,KC_K), KC_L,    L(ARROWS,KC_SCLN), \
        M(UNDS),   KC_X,          KC_C,           L(DESKTOP,KC_V), ALT(KC_B), L(LOWER,KC_ENT), L(RAISE,KC_SPC), ALT(KC_N), L(DESKTOP,KC_M), KC_COMM,        KC_DOT,  SFT(KC_BSLS) 
    ), 
    [LOWER] = LAYOUT_ortho_4x4(
        ...
        LSFT(KC_Z), LSFT(KC_X), LSFT(KC_C), LSFT(KC_V), LSFT(KC_B), USEDKEY, KC_BSPC, LSFT(KC_N), LSFT(KC_M), LSFT(KC_COMM), LSFT(KC_DOT), LSFT(KC_SLSH)
    ),
    [RAISE] = LAYOUT_ortho_4x4(
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0, \
        KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, \
        KC_ESC,  KC_TAB,  KC_PPLS, KC_EQL,  KC_Z,    KC_ESC,  USEDKEY, KC_MINS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR 
    ),
    [MIDDLE] = LAYOUT_ortho_4x4(
    ...
    [LOL] = LAYOUT_ortho_4x4(
        ...
        KC_G, KC_B, KC_D, KC_F, CTL(KC_ESC), KC_SPC, TG(LOL), _______, _______, _______, _______, _______ 
    )
};
