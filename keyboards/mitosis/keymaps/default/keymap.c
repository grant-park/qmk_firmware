...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = {
        ...
        {KC_TILD, KC_F4,   KC_F5,   KC_F6,   _______, M(21),   M(4),    M(5),    M(22),   KC_QUOT},
        {KC_PIPE, KC_F7,   KC_F8,   KC_F9,   _______, _______, M(23),   M(24),   _______, KC_SLSH},
    ...
    [2] = {
        ...
        {XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ESC,  USEDKEY, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX},
        {XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
    },
    ...
    [8] = {
        ...
        {XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    USEDKEY,    KC_BSPC,    XXXXXXX,    XXXXXXX,       XXXXXXX,      XXXXXXX},
        {XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX }
    },
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt) {
    switch(id) {
	    ...
	    case 14:
	        if (record->event.pressed) {
	    	// vim search replace
	    	return MACRO(T(S),T(SLSH),T(BSLS),D(LSFT),U(LSFT),D(LSFT),T(V),U(LSFT),END);
	        }
	        break;
	    case 15:
	        if (record->event.pressed) {
